                                        ...
                                        <form class="mt-4 pt-2" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group auth-pass-inputgroup">
                                                    <input id="password" name="password" type="password" class="form-control" placeholder="Enter password" aria-label="Password" aria-describedby="password-addon">
                                            ...
                                            <div class="row mb-4">
                                                <div class="col">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" name="remember" for="remember-check">
                                                            Remember me
                                                        </label>
                                                    </div>  
                                                </div>
